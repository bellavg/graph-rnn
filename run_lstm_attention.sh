...
#SBATCH --output=slurm_logs/lstm_attention_%j.out
...
OUTPUT_DIR="current_runs/lstm_attention_${SLURM_JOB_ID}"
mkdir -p $OUTPUT_DIR

# Config file to use (provide as parameter or default)
CONFIG_FILE=${1:-"configs/config_aig_lstm_attention.yaml"}
