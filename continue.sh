...
srun pyton -u --config_file configs/config_aig_base.yaml --restore new_runs/graphrnn_11003135/base_checkpoints/checkpoint-10000.pth --save_dir new_runs/graphrnn_11003135_continued
