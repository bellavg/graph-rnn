...
#SBATCH --mem=64G                # Explicit memory request
...
NUM_GRAPHS_PER_CHECKPOINT=10     # Reduced for debugging
NUM_PLOTS_TO_SAVE=5
TARGET_NODES=32                  # Reduced target nodes for faster generation
SORT_PLOTS_BY="nodes"
FORCE_MAX_NODES=64
FORCE_MAX_LEVEL=13
NUM_CHECKPOINTS_TO_EVAL=2        # Reduced to debug one checkpoint at a time

# --- New Parameters ---
TEMPERATURE=0.8                # Lower temperature for more deterministic sampling

# Additional flags for troubleshooting
MEMORY_MONITOR="--monitor_memory"   # Add a memory monitor flag
MAX_STEPS="--max_gen_steps 70"      # Enforce a strict maximum steps
...
# Only evaluate one specific checkpoint directory for debugging
CKPT_DIR="current_runs/rnn_11048520/checkpoints_11048520"
...
# Launch the evaluation job - with additional debugging parameters
